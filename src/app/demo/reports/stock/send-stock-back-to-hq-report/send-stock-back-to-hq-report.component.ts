...
@Component({
  selector: 'app-send-stock-back-to-hq-report',
  templateUrl: './send-stock-back-to-hq-report.component.html',
  styleUrls: ['./send-stock-back-to-hq-report.component.scss']
})
export class SendStockBackToHqReportComponent implements OnInit {
  ...
  getSendStocktoHQReport() {
    // receive_stock_report
    this.auth.store('send_stock_to_admin_report', this.data).subscribe(
      response => {
        // console.log(response['data']);
        this.isLoading = false;
