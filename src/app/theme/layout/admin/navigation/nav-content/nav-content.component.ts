...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  constructor(public nav: NavigationItem, private zone: NgZone, private location: Location, private auth: AuthenticationService) {
  ...
  confirmLogout() {
    Swal.fire({
      title: 'Are you sure?',
      text: 'Signing out would required logging back in to gain access.',
      type: 'warning',
